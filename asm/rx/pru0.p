...
CHECK_DONE:
	...
	MOV r0.b2, 0 // reset register count
	ADD r3.w0, r3.w0, 1 // increment packet count
	QBNE BCK_P4b8, r3.w0, r3.w2 // check if packet count == done
	JMP STOP
	//JMP BCK_P4b8 // else, backup
...
SMP_R29:
    MOV r0.b0, 0
    MOV r0.b1, DELAY_LAST_REG
    MOV r0.b1, r0.b1
	
DEL_R29:
    ADD r0.b0, r0.b0, 1
    QBNE DEL_R29, r0.b0, r0.b1
...
DEL_R29_B1b1:
	ADD r0.b0, r0.b0, 1
	QBNE DEL_R29_B1b1, r0.b0, DELAY_FWD
...
DEL_R29_B1b2:
	ADD r0.b0, r0.b0, 1
	QBNE DEL_R29_B1b2, r0.b0, DELAY_FWD
...
DEL_R29_B1b3:
	ADD r0.b0, r0.b0, 1
	QBNE DEL_R29_B1b3, r0.b0, DELAY_FWD
...
DEL_R29_B1b4:
	ADD r0.b0, r0.b0, 1
	QBNE DEL_R29_B1b4, r0.b0, DELAY_FWD
...
DEL_R29_B1b5:
	ADD r0.b0, r0.b0, 1
	QBNE DEL_R29_B1b5, r0.b0, DELAY_FWD
...
DEL_R29_B1b6:
	ADD r0.b0, r0.b0, 1
	QBNE DEL_R29_B1b6, r0.b0, DELAY_FWD
...
DEL_R29_B1b7:
	ADD r0.b0, r0.b0, 1
	QBNE DEL_R29_B1b7, r0.b0, DELAY_FWD
...
DEL_R29_B1b8:
	ADD r0.b0, r0.b0, 1
	QBNE DEL_R29_B1b8, r0.b0, DELAY_FWD
...
DEL_R29_B2b1:
	ADD r0.b0, r0.b0, 1
	QBNE DEL_R29_B2b1, r0.b0, DELAY_FWD
...
DEL_R29_B2b2:
	ADD r0.b0, r0.b0, 1
	QBNE DEL_R29_B2b2, r0.b0, DELAY_FWD
...
DEL_R29_B2b3:
	ADD r0.b0, r0.b0, 1
	QBNE DEL_R29_B2b3, r0.b0, DELAY_FWD
...
DEL_R29_B2b4:
	ADD r0.b0, r0.b0, 1
	QBNE DEL_R29_B2b4, r0.b0, DELAY_FWD
...
DEL_R29_B2b5:
	ADD r0.b0, r0.b0, 1
	QBNE DEL_R29_B2b5, r0.b0, DELAY_FWD
...
DEL_R29_B2b6:
	ADD r0.b0, r0.b0, 1
	QBNE DEL_R29_B2b6, r0.b0, DELAY_FWD
...
DEL_R29_B2b7:
	ADD r0.b0, r0.b0, 1
	QBNE DEL_R29_B2b7, r0.b0, DELAY_FWD
...
DEL_R29_B2b8:
	ADD r0.b0, r0.b0, 1
	QBNE DEL_R29_B2b8, r0.b0, DELAY_FWD
...
DEL_R29_B3b1:
	ADD r0.b0, r0.b0, 1
	QBNE DEL_R29_B3b1, r0.b0, DELAY_FWD
...
DEL_R29_B3b2:
	ADD r0.b0, r0.b0, 1
	QBNE DEL_R29_B3b2, r0.b0, DELAY_FWD
...
DEL_R29_B3b3:
	ADD r0.b0, r0.b0, 1
	QBNE DEL_R29_B3b3, r0.b0, DELAY_FWD
...
DEL_R29_B3b4:
	ADD r0.b0, r0.b0, 1
	QBNE DEL_R29_B3b4, r0.b0, DELAY_FWD
...
DEL_R29_B3b5:
	ADD r0.b0, r0.b0, 1
	QBNE DEL_R29_B3b5, r0.b0, DELAY_FWD
...
DEL_R29_B3b6:
	ADD r0.b0, r0.b0, 1
	QBNE DEL_R29_B3b6, r0.b0, DELAY_FWD
...
DEL_R29_B3b7:
	ADD r0.b0, r0.b0, 1
	QBNE DEL_R29_B3b7, r0.b0, DELAY_FWD
