...
#define REQBITS 12 // number of bits (out of 13) required to match actual preamble
...
P1_DEL: 
    ADD r0.b0, r0.b0, 1
    QBNE P1_DEL, r0.b0, P1_DELAY // delay s.t. 200 cycles between preamble reads

P1_CHK:
	AND r2.w0, r2.w0, PRE_BITMASK // ignore irrelevant bits
